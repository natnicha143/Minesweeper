...
\begin{document}
	...
	\par The current  version of minesweeper successfully meets the requirements of the traditional minesweeper game however it is still yet to implement the hexagon and colour-based minesweeper  modes successfully. 
		...
		\end{itemize}
			...
			\begin{itemize}
				...
				\item The use wins the game after flagging all the mines correctly.
				\item The scoring system of the game, also known as the game timer. 
				\item The hexagon minesweeper mode and colour-based minesweeper mode
			\end{itemize}	
	...
	\subsection{Product Use Cases}
		...
		Actor(s) & Target word input contains special character. \\
		...
		Exception condition(s) & Target word input is of different length to source word.\\
		\hline
	\end{tabular}
