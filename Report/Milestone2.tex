...
\begin{document}
	...
	\textbf{The following are product use cases for minesweeper}
	
	
	\subsection{Software Architecture}
	\textbf{Software architecture being used and its feasibility to remain the same until project completion.}
